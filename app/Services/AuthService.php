...
class AuthService
{
    ...
    public function loginApi(string $email, string $password, ?string $fingerprint = null): bool|string
    {
        $credential = [
            'email' => $email,
            'password' => $password,
    ...
    public function registerApi(RegistrationNewUserDTO $userData): string
    {
        /** @var User $newUser */
        $newUser = User::query()->create([
            'name' => $userData->getName(),
