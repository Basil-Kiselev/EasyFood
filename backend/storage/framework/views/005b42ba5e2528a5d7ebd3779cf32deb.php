...
<?php $__env->startSection('content'); ?>
    <div class="" style="width: 500px; margin: auto;">
        <form style="width: 400px; margin: auto; padding: 50px; " action="<?php echo e(route('registration')); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/registration.blade.php ENDPATH**/ ?>