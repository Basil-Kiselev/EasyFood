    ...
    public function run(): void
    {
        ...
        $articlesData = [
            [
                ...
                'alias' => 'morning_water',
                'img' => 'storage/img/article_img/morning_water.jpg',
            ...
            [
                ...
                'img' => 'storage/img/article_img/bicycle_benefit.jpg',
                'is_recommend' => random_int(0,1),
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'img' => 'storage/img/article_img/strawberry_mask.jpg',
                'is_recommend' => random_int(0,1),
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'img' => 'storage/img/article_img/no_meal_at_night.jpg',
                'is_recommend' => random_int(0,1),
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'img' => 'storage/img/article_img/physical_exercise.jpg',
                'is_recommend' => random_int(0,1),
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'alias' => 'how_right_eat',
                'img' => 'storage/img/article_img/how_right_eat.jpg',
                'is_recommend' => random_int(0,1),
                'created_at' => $now,
                'updated_at' => $now,
            ],
        ...
        foreach ($articlesData as $articleData) {
            ...
            if (!file_exists(base_path('public/img/articles'))) {
                mkdir('public/img/articles');
            }

            if (file_exists(base_path($articleData['img']))) {
