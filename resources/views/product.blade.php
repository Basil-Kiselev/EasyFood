            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large" src="{{ asset($productInfo->getImg()) }}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <ul>
                        ...
                        <li><b>{{ $productInfo->getMeasureName() }}</b>{{ $productInfo->getMeasureValue() }} {{ $productInfo->getMeasureType() }} <span></span></li>
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ asset($relatedProduct->getImg()) }}">
                            <ul class="product__item__pic__hover">
                                <li><a href="{{ route('add-favorite', $relatedProduct->getArticle()) }}"><i class="fa fa-heart"></i></a></li>
                                <li><a href="{{ route('addToCart', $relatedProduct->getArticle()) }}"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
                        <div class="product__item__text">
                            <h6><a href="{{ route('product', $relatedProduct->getArticle()) }}">{{ $relatedProduct->getName()}}</a></h6>
